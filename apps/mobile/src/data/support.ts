...
function tickets(tenantId: string): TicketAPI[] {
  return [
    {
      id: `tkt_${tenantId}_1`,
      tenant_id: tenantId,
...
export const TICKETS_API: Record<string, TicketAPI[]> = {
  [ID_PETSHOP]: tickets(ID_PETSHOP),
  [ID_ACARAJE]: tickets(ID_ACARAJE),
  [ID_SEM_APP]: tickets(ID_SEM_APP),
};

/** A thread do chamado 1; os demais abrem com a mensagem de abertura só. */
export const MESSAGES_API: Record<string, TicketMessageAPI[]> = Object.fromEntries(
  Object.values(TICKETS_API)
    .flat()
