...
const bars = (fator: number) =>
  BASE_BARS.map((b) => ({ day_label: b.day_label, amount_cents: b.peso * fator }));

export const REPORTS_API: Record<string, ReportAPI> = {
  [ID_PETSHOP]: {
    period: 'week',
    rows: [
      {
