...
const tokensClaros = {
  ...
  authInk: palette.authInk,
  authMuted: palette.authMuted,
  authFaint: palette.authFaint,
  authSurface: palette.authSurface,
  authBorder: palette.authBorder,
  authPill: palette.authPill,
  authLine: palette.authLine,
  authLink: palette.authLink,
  authBrand: palette.authBrand,
