...
/**
 * Grava a nova senha da pessoa que chegou pelo link do e-mail.
 *
 ...
 *
 * NÃO usa `requireCustomer`: aquilo é o portão dos DADOS do negócio, e exige
 * perfil com `tenant_id`. Aqui a operação é sobre a própria conta, e uma pessoa
 * com o cadastro pela metade continua tendo o direito de consertar a senha
 * dela. O que é indispensável — haver sessão — está checado logo abaixo.
 */
export async function setNewPassword(
   ...
   * digitada. Deixá-la de pé entregaria o portal a quem tivesse acesso àquela
   * caixa de entrada. Entrar de novo com a senha nova custa dez segundos e
   * confirma, para a própria pessoa, que a troca funcionou.
   */
