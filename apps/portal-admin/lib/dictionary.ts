...
const pt = {
  ...
  entrarTitulo: "Acesse o painel",
  entrarSub: "Acesso exclusivo da administração.",
  bannerRotulo: "Administração",
  bannerTitulo: "Uma visão completa da operação.",
  bannerTexto: "Gerencie clientes, planos e a operação da plataforma em um só lugar.",
  email: "E-mail",
  password: "Senha",
  signIn: "Entrar",
...
const en: Dic = {
  ...
  semPrecoFixo: "Custom",
  entrarTitulo: "Access the panel",
  entrarSub: "Administration access only.",
  bannerRotulo: "Administration",
  bannerTitulo: "A complete view of the operation.",
  bannerTexto: "Manage customers, plans, and platform operations in one place.",
  email: "Email",
  password: "Password",
  signIn: "Sign in",
